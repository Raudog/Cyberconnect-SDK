...
var CyberConnect = /** @class */ (function () {
    ...
    CyberConnect.prototype.authWithSigningKey = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var publicKey, acknowledgement, message, _c, signingKeySignature, resp, e_5;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        publicKey = _d.sent();
                        acknowledgement = "I authorize " + (this.signingMessageEntity || 'CyberConnect') + " from this device using signing key:\n";
